...
| Isolated preview target | Available for both Sites | Exercise a deployable Worker away from production. | PVD has its protected Preview target; SERP has protected source/replacement Preview D1 databases and a Worker rehearsed by Issue #72. | These shared Preview identities are not sufficient for concurrent PRs; do not create substitutes without explicit platform authority. |
